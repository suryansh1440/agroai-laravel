    ...
    <div class="relative h-full flex flex-col justify-center" x-data="{ step: 1 }">
        ...
        <div x-show="step === 2" x-cloak x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 translate-x-4" x-transition:enter-end="opacity-100 translate-x-0">
            ...
            <div class="space-y-6">
                ...
                <div class="pt-4">
                    <button type="submit" :disabled="isSubmitting" class="w-full py-4 bg-[#4cc9f0] hover:bg-[#43b5d8] text-white rounded-xl text-lg font-bold transition-all shadow-lg shadow-cyan-500/20 flex items-center justify-center gap-2">
                        <span x-show="!isSubmitting">{{ __('Complete Registration') }}</span>
